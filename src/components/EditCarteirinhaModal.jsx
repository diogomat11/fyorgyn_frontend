...
export default function EditCarteirinhaModal({ carteirinha, convenios, onClose, onSave }) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const selectedConv = convenios?.find(c => c.id_convenio.toString() === carteirinha.id_convenio?.toString());

        if (!validateCarteirinhaByConvenio(formData.carteirinha, selectedConv)) {
